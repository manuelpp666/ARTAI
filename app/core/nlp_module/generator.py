...
def generar_texto(modelo: Transformer, texto_inicio: str, longitud=200, temperatura=1.2, seq_len=50, device='cpu'):
    """Genera texto autoregresivo usando el transformer."""
    modelo.eval()
    generado = codificar(texto_inicio)
